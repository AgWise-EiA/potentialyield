...
execmodel <-dssat.exec(country = "Nigeria",  useCaseName = "AKILIMO", Crop = "Maize", AOI = FALSE,TRT=1:3)
...
mergeresults <-merge_DSSAT_output(country = "Nigeria",  useCaseName = "AKILIMO", Crop = "Maize", AOI = FALSE,season=NULL)
