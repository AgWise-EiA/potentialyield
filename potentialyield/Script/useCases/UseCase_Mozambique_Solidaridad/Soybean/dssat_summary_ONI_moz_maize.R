...
pathOut <- '/home/jovyan/agwise-potentialyield/dataops/potentialyield/Data/'
...
# Rename varieties
  ...
  dssat_oni$Variety <- gsub(v_levs[1], "medium", dssat_oni$Variety)
  dssat_oni$Variety <- gsub(v_levs[2], "long", dssat_oni$Variety)
  dssat_oni$Variety <- gsub(v_levs[3], "short", dssat_oni$Variety)
 #  
  # # med ONI > 0.5, Nino, med ONI < -0.5 Nina, -0.5 > ONI > 0.5 Neutral 
