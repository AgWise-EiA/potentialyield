...
expdata_AOI <- dssat.expfile(country = "Zambia",  useCaseName = "RAB", Crop = "Maize", AOI = TRUE, filex_temp="ESAC8501.SBX", Planting_month_date="10-15", Harvest_month_date="05-15",jobs=10, ID="TLID",season =1, plantingWindow=4)
