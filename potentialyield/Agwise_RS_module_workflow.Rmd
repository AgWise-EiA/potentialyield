...
author: "Payel Gosh, Leroux Louise, Amit Srivastava, Meklit Chernet"
date: "2024-04-15"
...
3.2. Download the crop mask from GEE and place it in the CropMask folder of useCase for example, **agwise-datasourcing/dataops/datasourcing/Data/useCase_Rwanda_RAB/MODISdata/raw/CropMask/Cropmask_Rwn250m.tif**
...
3.4.  Fill in the correct arguments in the script you copied, i.e., **get_MODISdata_useCase_Rwanda_RAB.R/get_MODISts_PreProc_useCase_Rwanda_RAB.R**  in your newly created folder:
  - change the country,level,admin_unit_name ,use case name, planting year, harvest year, etc. For deeper understanding of the different arguments please refer to the documentation in *get_MODISdata.R/get_MODISts_PreProc.R*.
...
#################################################################################################################
## Smmoth the data to fill in gaps
#################################################################################################################
source("~/agwise-datasourcing/dataops/datasourcing/Scripts/generic/get_MODISts_PreProc.R")
