...
get_RelativeHumidity_pointSummarydata <- function(country, useCaseName, Crop, AOI = FALSE, overwrite = FALSE, 
  ...
  fname_RH <- ifelse(AOI == "TRUE", paste("RelativeHumidity_summaries_AOI_", season,"_" ,Planting_month_date, "_", dataSource, ".RDS",sep=""), paste("RelativeHumidity_summaries_trial_", dataSource, ".RDS", sep=""))
...
get_RelativeHumidity_pointData <- function(country, useCaseName, Crop, AOI = FALSE, overwrite = FALSE, 
  ...
  fname_RH <- ifelse(AOI == "TRUE", paste("RelativeHumidity_pointData_AOI_", season,"_" ,Planting_month_date, "_", dataSource, ".RDS",sep=""), paste("RelativeHumidity_pointData_trial_", dataSource, ".RDS", sep=""))
