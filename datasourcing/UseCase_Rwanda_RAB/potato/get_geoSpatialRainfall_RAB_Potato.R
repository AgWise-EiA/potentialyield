...
trial_point_Rf_CHIRPS <- get_rf_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Potato", AOI = FALSE,
              ...
              harvest_month_date = NULL, planting_harvest_sameYear = TRUE, jobs=10, dataSource = "CHIRPS")
...
AOI_point_Rf_sameYear_p1  <- get_rf_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Potato", AOI = TRUE,
                         ...
                         harvest_month_date = "06-05", planting_harvest_sameYear = TRUE, jobs=10, dataSource = "CHIRPS")


AOI_point_Rf_sameYear_p2  <- get_rf_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Potato", AOI = TRUE,
                                           overwrite = TRUE,season="season1", Planting_month_date = "02-12",  
                                           harvest_month_date = "06-12", planting_harvest_sameYear = TRUE, jobs=10, dataSource = "CHIRPS")
