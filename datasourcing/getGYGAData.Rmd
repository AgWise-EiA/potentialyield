...
```{r coordinatesWeatherStations, echo=FALSE}
...
# read .csv file with data and convert to spatial dataframe
...
# load climate zones and merge to field data and join field data with climate zones
```{r R8, echo=FALSE}
...
# fields with or without yield data
